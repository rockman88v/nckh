	...
	<div class="Section1">
		<div style="margin: 0;box-shadow: 0;font-size: 17px;">
			...
			<div style="width: 267mm;">
				<p style="padding-left:1cm;">I. Đề tài Nghiên cứu khoa học cấp cơ sở</p>
				<!-- NỘI DUNG ĐÁNH GIÁ -->
				<table border="1" style="border-collapse: collapse;width: 100%;font-size: 17px;">
					<tr style="text-align: center;">
						...
						<th style="width: 4cm;">Tên CBGV, Đơn vị</th>
...
<?php 
 ...
 ?>
				...
				<table style="width: 267mm;">
					<tr style="text-align: center;">
						<th style="width: 33%;">Giám đốc</th>
						<th style="width: 33%;">Phòng Quản lý NCKH</th>
