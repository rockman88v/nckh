...
<html>
  <head>
    <meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>Website Quản lý nghiên cứu khoa học</title><meta name="description" content=""><meta name="viewport" content="width=device-width, initial-scale=1"><base href="<?php echo $qlkh['HOSTADMIN']; ?>"><link rel="stylesheet" href="vendor/bootstrap/css/bootstrap.min.css"><link rel="stylesheet" href="css/fontastic.css"><link rel="stylesheet" href="css/grasp_mobile_progress_circle-1.0.0.min.css"><link rel="stylesheet" href="css/style.css" id="theme-stylesheet"><link rel="shortcut icon" href="../images/favicon.ico"><script  type="text/javascript" src="../js/sweetalert.min.js"></script><script src="../js/jquery-3.3.1.min.js"></script><script src="js/popper.js" type="text/javascript"></script><script src="vendor/bootstrap/js/bootstrap.min.js"></script><link rel="stylesheet" type="text/css" href="../bootstrap/css/bootstrap-select.min.css"><script type="text/javascript">function kiemtraketnoi(){var xhr = new XMLHttpRequest();var file='<?php echo $qlkh['HOSTGOC']; ?>test-connect-internet.png';var r=3000;xhr.open('HEAD',file+'?subins='+r,false);try{xhr.send();if(xhr.status>=200&&xhr.status<304)return true;else return false;}catch(e){return true;}};function dongmodal(id){$("#"+id).modal('hide');};function khongthanhcong(chuoi){$.notify(chuoi,{animate:{enter:'animated fadeIn',exit:'animated fadeOut'},placement:{from:'top',align:'right'},type:'danger',delay:4000});};function canhbao(chuoi){$.notify(chuoi,{animate:{enter:'animated fadeIn',exit:'animated fadeOut'},placement:{from:'top',align:'right'},type:'warning',delay: 2000});};function thanhcong(chuoi){$.notify(chuoi,{animate:{enter:'animated fadeIn',exit:'animated fadeOut'},placement:{from:'top',align:'right'},type:'success',delay:3000});}</script>
  </head>
  <body>
    <!-- Side Navbar -->
      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <?php } else if($loaitaikhoan=='truongkhoaphong'){ ?>
            <li id="quanlydetai"><a href="?p=quanlydetai"> <i class="fas fa-external-link-alt"></i>Quản lý đề tài của tôi</a></li>
            <li id="dexuatmoi"><a href="?p=dexuatmoi"> <i class="fas fa-align-right"></i>ĐT đang đề xuất</a></li>
            <li id="dangthuchien"><a href="?p=dangthuchien"> <i class="fas fa-align-right"></i>ĐT đang thực hiện</a></li>
            <li id="denhanbaocao"><a href="?p=denhanbaocao"> <i class="fas fa-align-right"></i>Đến hạn báo cáo</a></li>
            <li id="tretiendo"><a href="?p=tretiendo"> <i class="fas fa-align-right"></i>Trễ tiến độ</a></li>
            <div class="admin-menu">
                  <h5 class="sidenav-heading">Báo khoa học</h5>
    ...
    <div class="page">
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <p>&copy; Copyright of BCN.2020.T03.05</p>
            </div>
            <div class="col-sm-6 text-right">
              <p>Phiên bản: <a href="#" class="external">V.01</a></p>
            </div>
          </div>
        </div>
      </footer>
