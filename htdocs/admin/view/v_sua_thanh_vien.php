                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input disabled type="text" class="form-control" id="hoten" value="<?php echo $nd['HO']." ".$nd['TEN'] ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="category" class="font-weight-bold" >Gới tính (<span class="text-danger">*</span>)</label>
                                            <select disabled id="gioitinh" class="form-control">
                           ...
                           <!--              <div class="form-group col-md-4">
                                            ...
                                            <input type="radio" id="gv" <?php if($nd['GIAOVIEN']==1) echo "checked" ?> name="ltv" style="transform: scale(1.8);">&ensp;Cán bộ/Giáo viên&ensp;&ensp;&ensp;<input type="radio" id="sv" name="ltv" <?php if($nd['GIAOVIEN']==0) echo "checked" ?> style="transform: scale(1.8);">&ensp;Sinh viên
                                        </div>
							-->			
                                        <div class="form-group col-md-4">
                                            <label for="category" class="font-weight-bold" >Ngày, tháng, năm sinh (<span class="text-danger">*</span>)</label>
                                            <input disabled type="date" class="form-control" id="ngaysinh" value="<?php echo $nd['NGAYSINH'] ?>">
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select disabled class="form-control selectpicker" data-live-search="true" id="chucvu">
                                                <option value='0'>---</option>
                                            <?php 
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select disabled class="form-control selectpicker" data-live-search="true" id="donvicongtac">
                                                <option value='0'>---</option>
                                            <?php 
