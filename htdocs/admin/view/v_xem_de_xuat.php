                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-12">
                                                    ...
                                                    if($trangthaidt=='Đang thực hiện'){
														...
														<div class="col-md-12"><?php echo "<span class='badge badge-success' style='font-size: 16px;'>Đề tài đang thực hiện</span>"; ?></div>
														<b><?php if($detai['THOIGIANNGHIEMTHU'] != NULL)echo "Ngày nghiệm thu: " . date("d-m-Y", strtotime($detai['THOIGIANNGHIEMTHU'])); ?></b>
														<hr>
														<div class="col-md-12">
