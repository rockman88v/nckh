	...
	<div class="Section1">
		<div style="margin: 0;box-shadow: 0;font-size: 17px;">
			<table style="width: 190mm;">
				<tr>
					<td style="font-size: 16px;text-align: center;">BỘ CÔNG AN<br><b>HỌC VIỆN CHÍNH TRỊ CAND</b><hr style="width: 40%"></td>
			...
			<table style="width: 190mm;text-align: center;">
				<tr>
					<th colspan="3">KẾ HOẠCH XÉT DUYỆT ĐỀ TÀI NCKH CẤP CƠ SỞ<br>Năm học 20 ... - 20 ...</th>
				</tr>
				<tr>
					<td style="width: 1.4cm;"></td>
					<td>(Kèm theo Quyết định số:    /QĐ-T03-P5, ngày ..... tháng ..... năm ...... của Giám đốc Học viện Chính trị CAND)</td>
					<td style="width: 1.4cm;"></td>
				</tr>
			</table>
			<div style="width: 190mm">
				...
				<table style="width: 190mm;">
					<tr>
						<td></td>
						<td style="text-align: center;width: 80mm;"><i>Hà Nội, ngày <?php echo $ngay ?> tháng  <?php echo $thang ?>  năm <?php echo $nam ?></i><br><br><b>BAN TỔ CHỨC</b></td>
					</tr>
				</table>
			</div>
		</div>
