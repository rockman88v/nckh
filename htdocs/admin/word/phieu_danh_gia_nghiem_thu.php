...
<?php 
 ...
 header("content-disposition: attachment;filename=Phieu danh gia nghiem thu - ".$detai['TENDETAI'].".doc");
?>
<html>
<head>
    <style>
...
<!--				<td style="text-align: center;width: 20mm"><img src="<?php var_dump ($qlkh); echo $qlkh[2] ?>word/.png" width="70" height="70"></td>  -->
			...
			<div style="font-size: 18.5px;text-align: center;font-weight: bold;">
				<p> PHIẾU ĐÁNH GIÁ NGHIỆM THU ĐỀ TÀI<br>ĐỀ TÀI NCKH CẤP CƠ SỞ<br>NĂM HỌC  20 ... – 20 ...</p>
			</div>	
			<div style="width: 180mm;">	
				...
				<p>4 - Cơ quan chủ trì: <b>Học viện Chính trị CAND</b></p>
