...
<!--				<td style="text-align: center;width: 20mm"><img src="<?php var_dump ($qlkh); echo $qlkh[2] ?>word/.png" width="70" height="70"></td>  -->
			...
			<div style="font-size: 18.5px;text-align: center;font-weight: bold;">
				<p> PHIẾU GIAO NHẬN SẢN PHẨM KH & CN<br>ĐỀ TÀI CẤP ......<br>NĂM HỌC  20 ... – 20 ...</p>
			</div>	
			<div style="width: 170mm;">
				...
				<table style="width: 180mm;">
					<tr style="text-align: center;">
						<th style="width: 6cm;">BÊN GIAO</th>
						<th style="width: 6cm;"></th>
						<th style="width: 6cm;">BÊN NHẬN</th>
					</tr>
				</table>
			</div>
		</div>
