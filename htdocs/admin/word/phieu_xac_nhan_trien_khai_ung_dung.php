	...
	<div class="Section1">
		<div style="margin: 0;box-shadow: 0;font-size: 17px;">
			<table id="bangheader" border="1" style="border-collapse: collapse;width: 170mm;">
				<tr>
<!--				<td style="text-align: center;width: 20mm"><img src="<?php var_dump ($qlkh); echo $qlkh[2] ?>word/.png" width="70" height="70"></td>  -->
					<td style="font-size: 18.5px;text-align: center;width: 60mm;">BO CONG AN<br><b>HOC VIEN CHINH TRI CAND</b></td>
					<td style="font-size: 18.5px;text-align: center;width: 120mm;font-weight: bold;">CONG HOA XA HOI CHU NGHIA VIET NAM<br>Doc lap - Tu do - Hanh phuc</td>
				</tr>
			</table>
			<br>
			<div style="font-size: 18.5px;text-align: center;font-weight: bold;">
				<p> PHIẾU XÁC NHẬN TRIỂN KHAI ỨNG DỤNG<br>ĐỀ TÀI CẤP ......<br>NĂM HỌC  20 ... – 20 ...</p>
			</div>	
			<div style="width: 170mm;">
				...
				<p>Đề tài này đã được triển khai ứng dụng thực hiện tại đơn vị: ............................................</p>
				<p>Nội dung ứng dụng: Tài liệu phục vụ công tác giảng dạy và nghiên cứu</p>
				<p>Tài liệu bàn giao: .................................</p>
				<p>Tình trạng tài liệu: ................................</p>

				<!-- NGÀY THÁNG VIẾT ĐỀ XUẤT -->
				<p style="text-align: right;margin-top: 4mm;padding-right: 1mm"><i>Hà Nội</i>, ngày ...... tháng ...... năm ......</p>
				<!-- KÝ TÊN XÁC NHẬN -->
				<table style="width: 170mm;">
					<tr style="text-align: center;">
						<th style="width: 7cm;">PHÒNG QUẢN LÝ NCKH</th>
						<td></td>
