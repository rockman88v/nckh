	...
	<div class="Section1">
		<div style="margin: 0;box-shadow: 0;font-size: 17px;">
			<table id="bangheader" border="1" style="border-collapse: collapse;width: 180mm;">
				<tr>
					<td style="text-align: center;width: 20mm"><img src="<?php echo $qlkh['HOSTADMIN'] ?>word/t03.png" width="70" height="70"></td>
			...
			<div style="width: 190mm;">
				...
				<p style="text-align: right;margin-top: 4mm;padding-right: 1mm"><i>Hà nội</i>, ngày ...... tháng <?php echo $thang ?> năm <?php echo $nam ?></p>
				<!-- KÝ TÊN XÁC NHẬN -->
				<table style="width: 180mm;">
					<tr style="text-align: center;">
						<th style="width: 25%;">Thủ trưởng đơn vị</th>
						<th style="width: 25%;">Phòng Hậu cần</th>
						<th style="width: 25%;">Phòng Quản lý NCKH</th>
						<th style="width: 25%;">Cán bộ lập bảng</th>
					</tr>
				</table>
			</div>
		</div>
