...
<div class="container">	
	<div class="khung">
		...
		<marquee behavior="alternate" scrolldelay="200" style="font-size: 0.8rem; color: white; background: url(images/bg_bar.gif) repeat-x; padding: 3px 0;line-height: 1.3rem;border-radius: 8px;" onmouseover="this.stop();" onmouseout="this.start();" >Phòng Quản lý nghiên cứu khoa học, Học viện Chính trị Công an nhân dân</marquee>
		<div id="maincontent">
		...
		<div id="footer">
			<div id="ft_nav">
				<ul>
					...
					//<li><a href="http://qlkh.t03:8888" target="_blank" rel="noopener">Giới thiệu</a></li>
					<li><a href="http://<?php echo getenv('DOMAIN') . ':' . getenv('PORT'); ?>" target="_blank" rel="noopener">Giới thiệu</a></li>
					<li><a href="bieumau">Văn bản - Biểu mẫu</a></li>
					//<li><a href="http://qlkh.t03:8888" style="border-right: none" target="_blank" rel="noopener">Liên hệ</a></li>
					<li><a href="http://<?php echo getenv('DOMAIN') . ':' . getenv('PORT'); ?>" target="_blank" rel="noopener">Liên hệ</a></li>
				</ul>
			</div>
			<div class="clear"></div>
			<div class="ft_cnt">
				<div style="float:left">
					<div>Phòng Quản lý Nghiên cứu khoa học</div>
					<div>Học viện Chính trị Công an nhân dân</div>
					<div>Địa chỉ: Tiên Dược, Sóc Sơn, Hà Nội</div>
					<div>Điện thoại: 0912.345.678</div>
					<div>Email: <a href="mailto:admin@hvctcand.com">admin@hvctcand.com</a></div>
					<div>Hỗ trợ kỹ thuật: <a href="mailto:admin@hvctcand.com">admin@hvctcand.com</a> - 0912.345.678</div>
				</div>
				<div class="clear"></div>
			</div>
		</div>
