...
$string['mustbesubmittedby'] = 'Học viên nộp bài lúc {$a}.';
$string['name'] = 'Name';
...
$string['quizavailable'] = 'Bài kiểm tra vẫn mở cho đến lúc: {$a}';
$string['quizclose'] = 'Close the quiz';
$string['quizclosed'] = 'Bài kiểm tra đóng lúc {$a}';
$string['quizcloses'] = 'Quiz closes';
$string['quizeventcloses'] = '{$a} closes';
$string['quizcloseson'] = 'Bài kiểm tra sẽ đóng lúc {$a}.';
...
$string['quiznavigation'] = 'Các câu hỏi';
...
$string['quizopened'] = 'Bài kiểm tra hiện tại đã mở.';
$string['quizopenedon'] = 'Bài kiểm tra từ {$a}';
$string['quizopens'] = 'Quiz opens';
$string['quizopenwillclose'] = 'Bài kiểm tra hiện tại đã mở, và sẽ đóng lúc {$a} at';
...
$string['returnattempt'] = 'Quay trở lại bài kiểm tra';
...
$string['startattempt'] = 'Bắt đầu kiểm tra';
...
$string['summaryofattempts'] = 'Tóm tắt những lần kiểm tra trước của bạn';
